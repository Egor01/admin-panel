...
gulp.task('copy:libs', function(callback) {
	...
	gulp.src('node_modules/owl.carousel/dist/**/*.*')
		.pipe(gulp.dest('./build/libs/owl-carousel/'))
	
	gulp.src('node_modules/@fortawesome/**/*.*')
		.pipe(gulp.dest('./build/libs/font-awesome-v5/'))

	// gulp.src('node_modules/jquery-parallax.js/**/*.*')
	// 	.pipe(gulp.dest('./build/libs/jquery-parallax.js/'))

	// gulp.src('node_modules/@fancyapps/fancybox/dist/**/*.*')
	// .pipe(gulp.dest('./build/libs/fancybox3/'))

	// gulp.src('node_modules/mixitup/dist/**/*.*')
	// .pipe(gulp.dest('./build/libs/mixitup3/'))

	// gulp.src('node_modules/jquery-validation/dist/**/*.*')
	// .pipe(gulp.dest('./build/libs/jquery-validation/'))

	// gulp.src('node_modules/magnific-popup/dist/**/*.*')
	// .pipe(gulp.dest('./build/libs/magnific-popup/'))

	// gulp.src('node_modules/wow.js/**/*.*')
	// .pipe(gulp.dest('./build/libs/wow.js/'))

	gulp.src('node_modules/page-scroll-to-id/**/*.*')
	.pipe(gulp.dest('./build/libs/page-scroll-to-id/'))
...
gulp.task('default', function(callback){
    runSequence(
    	'clean:build',
    	['styles', 'pug', 'svg', 'copy:libs', 'copy:img', 'copy:js', 'copy:php',],
    	'server',
		callback
    )
});
